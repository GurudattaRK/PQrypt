...
import com.pineapple.app.databinding.ActivityBluetoothKeyExchangeBinding
...
class BluetoothKeyExchangeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val savedFolder = getSharedPreferences("pineapple_prefs", MODE_PRIVATE)
    ...
    private fun startBluetoothServer() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                serverSocket = bluetoothAdapter?.listenUsingRfcommWithServiceRecord("PineappleKeyExchange", MY_UUID)
