package com.pineapple.app; // Package namespace for this Java class

/**
 * RustyCrypto - Java interface to the Rust crypto library // Class-level description
 * This class provides access to all crypto functions needed for the Pineapple app // Summary of purpose
 */
