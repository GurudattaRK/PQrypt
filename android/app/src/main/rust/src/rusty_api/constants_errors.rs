...
pub const CHACHA20_NONCE_SIZE: usize = 12;  // TEST: Try 12 bytes
pub type ChaChaKey = [u8; CHACHA_KEY_SIZE];
pub type ChaChaNonce = [u8; CHACHA20_NONCE_SIZE];
...
pub const PACKAGE1_SIZE: usize = 58636; // SLHDSA_SIGNATURE_SIZE + COMBINED_KEY1_SIZE + SLHDSA_PUBLIC_SIZE
pub const PACKAGE2_SIZE: usize = 66412; // SLHDSA_SIGNATURE_SIZE + COMBINED_KEY2_SIZE + SLHDSA_PUBLIC_SIZE
